...
sys.path.append('../')
from tools.img import tensor2ndarray, rgb2yuv, yuv2rgb, plot_space_target_space, dct_2d_slide_window, dct_2d_full_scale
...
if __name__ == '__main__':
    ...
    for i in tqdm(range(total)):
        ...
        x_dct = dct_2d_full_scale(x_space.astype(float))
        x_dct_poison = dct_2d_full_scale(x_space_poison.astype(float))
    ...
    rec_err = (x_dct_poison - x_dct).mean()
    print(rec_err)
